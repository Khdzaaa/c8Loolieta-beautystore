...
<head>
    ...
    <title>{{ 'Loolieta Admin Page' }}</title>
    <!-- Styles -->
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        @if(!empty(auth()->user()->id))
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="{{ route('admin.produk') }}">Product List</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="{{ route('admin.kategori') }}">Category Data</a>
                            </li>
                        @endif
