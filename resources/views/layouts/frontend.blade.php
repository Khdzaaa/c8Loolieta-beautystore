...
<html lang="en">
    <head>
        <title>{{ 'Loolieta Store | Beauty and Kind' }}</title>
        <!-- Required meta tags -->
        <!-- CSRF Token -->
        <meta name="csrf-token" content="{{ csrf_token() }}">
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <meta content="Loolieta Store. We provide the best beauty products to make your day!" name="description">
        <meta content="{{ 'Loolieta Store' }}" name="keywords">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md navbar-custom shadow-sm py-3 fixed-top">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}"><b>{{ 'Loolieta Store' }}</b></a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <p class="pt-2">Jl. Yodkali no. 8 Cibeunying Kidul</p>
                    ...
                    <div class="col-sm-4">
                        ...
                        <a href="https://www.instagram.com/" class="text-terhubung"><i class="fab fa-instagram"></i></a>
                        <a href="https://twitter.com/" class="text-terhubung"><i class="fab fa-twitter"></i></a>
                        <a href="https://www.youtube.com/" class="text-terhubung"><i class="fab fa-youtube"></i></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="copyright">
            <div class="container text-center">
                Copyright &copy; <?= date('Y');?> Laravel All Reserved
                <br>
                Beauty Store Web App || Tugas Besar Pemrograman Web Lanjut
            </div>
        </div>
        <!-- end footer -->
        <!-- modal cari -->
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">
                            <i class="fas fa-search mr-2"></i> Search a Product
                        </h5>
